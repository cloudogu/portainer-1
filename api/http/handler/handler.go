...
import (
	...
	"github.com/cloudogu/portainer-ce/api/http/handler/docker"
	...
	"github.com/cloudogu/portainer-ce/api/http/handler/kubernetes"
	...
	"github.com/cloudogu/portainer-ce/api/http/handler/ssl"
